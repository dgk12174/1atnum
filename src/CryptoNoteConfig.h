...
//pragma once not working so using below
...
namespace parameters {
  ...
  const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xD; // addresses start with "intu"
  ...
  const uint64_t MONEY_SUPPLY                                  = (uint64_t)(999999999999999999); //-1
  ...
  const unsigned EMISSION_SPEED_FACTOR                         = 1; // was 18
  ...
  const size_t   CRYPTONOTE_DISPLAY_DECIMAL_POINT              = 0; //was 8
  ...
  const char     CRYPTONOTE_BLOCKS_FILENAME[]                  = "1atnum-blocks.dat";
  const char     CRYPTONOTE_BLOCKINDEXES_FILENAME[]            = "1atnum-blockindexes.dat";
  const char     CRYPTONOTE_BLOCKSCACHE_FILENAME[]             = "1atnum-blockscache.dat";
  const char     CRYPTONOTE_POOLDATA_FILENAME[]                = "1atnum-poolstate.bin";
  const char     P2P_NET_DATA_FILENAME[]                       = "1atnum-p2pstate.bin";
  const char     CRYPTONOTE_BLOCKCHAIN_INDICES_FILENAME[]      = "1atnum-blockchainindices.dat";
  const char     MINER_CONFIG_FILE_NAME[]                      = "1atnum-miner_conf.json";
  } // parameters
...
const char     CRYPTONOTE_NAME[]                             = "1atnum";
const char     GENESIS_COINBASE_TX_HEX[]                     = "010a01ff0001904e029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd0880712101111ebf0ea973ca674ea004b64240073749b54fd27364b85c198ba1a19629444d";

const uint32_t GENESIS_NONCE                                 = 70;
const uint64_t GENESIS_TIMESTAMP                             = 1588449859;
...
const int      P2P_DEFAULT_PORT                              = 17493;
const int      RPC_DEFAULT_PORT                              = 17492;
...
const std::initializer_list<const char*> SEED_NODES = {
  ...
  "75.140.50.99:17492",
  "13.52.254.39:17493",
  "54.183.246.246:17492",
  "www.globus1.com:17493",
  "www.globus1.online:17492"
};
